...
Esta capa encapsula las tablas `orders` y `order_details` y mantiene el acceso
a datos aislado de las reglas de negocio.
"""
...
class OrderRepository(BaseRepository):
    ...
    def _normalize_error(self, exc: Exception) -> str:
        ...
        return message or "Error inesperado en el repositorio de pedidos"
